...
impl Program {
    pub fn get_ui_information(&self, info_popup: bool) -> iced::widget::Container<Message> { 
        if info_popup {
            return container(
                widget::column![
                    widget::text("Ollama GUI is a simple GUI for Ollama, a local AI model serving tool.").size(20),
                    Space::with_height(Length::Fixed(10.0)),
                    widget::text("It allows you to interact with AI models, install new models, and manage system prompts."),
                    Space::with_height(Length::Fixed(10.0)),
