...
use iced::{ Background, Border, Color, Length, Shadow, Theme, Vector, alignment::{self, Horizontal}, border::Radius, widget::{self, Space, container} };
...
impl Program {
    pub fn get_ui_information<'a>(&'a self, gui_state: &'a GUIState) -> iced::widget::Container<'a, Message> {
            match gui_state {
            GUIState::InfoPopup => {
                return container(
                    widget::column![
                            ...
                            Correspondence::User(text) => {
                                widget::row!(
                                    ...
                                    widget::container(
                                        ...
                                        .size(user_information.text_size)
                    ...
                    widget::column![
                                        ...
                                        widget::container( 
                                            markdown::view(
                                                ...
                                                iced::widget::markdown::Settings::with_text_size(
                                                    user_information.text_size, Theme::Dark)
                                            )
                                            .map(|_| Message::None)
                                        )
                                        .align_x(Horizontal::Left)
                            ...
                            Space::new().height(Length::Fixed(5.0)),
                                ...
                                widget::checkbox(self.user_information.think)
                                    .label("Thinking (only for applicable models)")
                    ...
                    return widget::container(
                        widget::column![
                            ...
                            widget::row!(
                                ...
                                Space::new().width(Length::Fixed(280.0)),
                            ...
                            widget::row!(
                                ...
                                Space::new().width(Length::Fixed(200.0)),
                            ),
                                                        Space::new().height(Length::Fixed(10.0)),
                            ...
                            widget::row!(
                                widget::checkbox(user_information.current_chat_history_enabled)
