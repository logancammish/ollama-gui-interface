...
use crate::{
    ChatImage, Correspondence, GUIState, Language, MarkdownImageState, Message, Program,
    ThinkingLevel, split_thinking_text,
                                ...
                                widget::column![
                                    ...
                                    widget::row![
                                        setting_label(
                                            ...
                                            tr(language, "After web research starts, the model runs 3–6 targeted searches and checks 2–6 relevant pages across independent sites.")
                                        ),
                                        widget::checkbox(
