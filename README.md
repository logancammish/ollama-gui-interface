...
## Please note:
As of Ollama `0.10.0`, Ollama now has an official GUI interface - however, as far as I see as of `1.17.7`, it does not provide the following features:
...
6. Highly customisable settings 
